      ...
      <form class="mt-10 w-full max-w-lg">
        ...
        <div>
          <div class="grid pb-14">
            <button class="shadow justify-self-center bg-teal-400 hover:bg-teal-400 focus:shadow-outline focus:outline-none text-white font-bold text-xl bg-black py-2 px-4 rounded" type="button">
              Send
            </button>
          </div>
        </div>
